...
package com.example.tgapplication.fragment.account.profile.cropphoto;
...
public class CropImageView extends FrameLayout {
   ...
   * @return a new Bitmap representing the cropped image
   */
  private Bitmap getCroppedImage(int reqWidth, int reqHeight, RequestSizeOptions options) {
   ...
   * @param options the resize method to use, see its documentation
   */
  private void getCroppedImageAsync(int reqWidth, int reqHeight, RequestSizeOptions options) {
  ...
  void onSetImageUriAsyncComplete(BitmapLoadingWorkerTask.Result result) {
    ...
    if (listener != null) {
      listener.onSetImageUriComplete(result.error);
    }
  }
    ...
    if (listener != null) {
      CropResult cropResult =
          new CropResult(
              ...
              getRotatedDegrees(),
              result.sampleSize);
      listener.onCropImageComplete(cropResult);
    }
  }
  ...
  public interface OnSetImageUriCompleteListener {
    ...
    void onSetImageUriComplete(Exception error);
  }
  // endregion
  ...
  public interface OnCropImageCompleteListener {
     ...
     */
    void onCropImageComplete(CropResult result);
  }
  // endregion
