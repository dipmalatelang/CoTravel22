...
public class CropImageActivity extends AppCompatActivity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    mCropImageUri = Objects.requireNonNull(bundle).getParcelable(CropImage.CROP_IMAGE_EXTRA_SOURCE);
  ...
  @Override
  public void onSetImageUriComplete(Exception error) {
    if (error == null) {
  ...
  @Override
  public void onCropImageComplete(CropImageView.CropResult result) {
