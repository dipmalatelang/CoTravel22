...
//        spinner.setSelection(StateAdapter.getPosition(new State("+91","India")));
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view,
                ...
                Log.i(TAG, "onViewClicked: "+spinner.getSelectedItem());
...
//                Toast.makeText(EditPhoneActivity.this, ""+user.getCode(), Toast.LENGTH_SHORT).show();
        ...
        if (sharedPreferences.contains("Phone")) {
            ...
            Log.i(TAG, "onCreate: Checking Phone " + mobile+" "+mobileCode);
    ...
    private class State {
       ...
       private String statename;
        ...
        public String toString() {
            return this.statename;            // What to display in the Spinner list.
        }
    }
}